...
<div class="alert alert-success alert-dismissible" role="alert">
    ...
    <strong>Hello! </strong> Welcome to your profile <strong><?php echo $usname; ?></strong> 
</div>
<div class="searchBAR">
        <form method="POST">
            ...
            ?>
                <div class="col-md-4">
                    <div class="well bg-info" style="height: 350px;">
                        ...
                        <a href="register_intern.php?id=<?php echo $row['id']; ?>&type=internship" class="btn btn-block btn-success">Apply</a>
            ...
            ?>
                <div class="col-md-4">
                    <div class="well bg-info" style="height: 350px;">
                        ...
                        <a href="register_intern.php?id=<?php echo $row['id']; ?>&type=job" class="btn btn-block btn-success">Apply</a>
